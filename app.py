...
def generate_questions_real(text_content, num_questions=3, difficulty="medium"):
    prompt = f"""Dựa vào nội dung sau, hãy tạo {num_questions} câu hỏi trắc nghiệm mức độ {difficulty}.

Nội dung:
{text_content[:3000]}

Yêu cầu:
- Tạo CHÍNH XÁC {num_questions} câu hỏi trắc nghiệm
- Mỗi câu có 4 đáp án (A, B, C, D)
- Mức độ: {difficulty}
- Trả về format JSON (KHÔNG thêm markdown):
[
  {{"question": "Câu hỏi?", "options": {{"A": "Đáp án A", "B": "Đáp án B", "C": "Đáp án C", "D": "Đáp án D"}}, "correct_answer": "A", "explanation": "Giải thích ngắn"}}
]"""
